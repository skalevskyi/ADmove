...
function splitBold(text: string, emphasis: 'semibold' | 'medium'): ReactNode {
...
export function SeoPubliciteVoitureContent() {
  const { t } = useLanguage();
  const s = t.seoPubliciteVoiture;
          ...
          <div className="mx-auto max-w-6xl px-4 md:px-6">
            <div className="mx-auto max-w-4xl">
              ...
              <div className="mt-6 space-y-4 text-base leading-relaxed text-slate-600 dark:text-slate-300">
                <p>{splitBold(s.section1Paragraph1, 'semibold')}</p>
                <p>{splitBold(s.section1Paragraph2, 'semibold')}</p>
                <p>{splitBold(s.section1Paragraph3, 'semibold')}</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-6xl px-4 md:px-6">
            <div className="mx-auto max-w-4xl">
              ...
              <div className="mt-8 grid gap-6 md:gap-8">
                <div className="rounded-xl border border-slate-200 bg-white p-6 dark:border-slate-700 dark:bg-slate-800/55">
                  <h3 className="text-lg font-semibold text-slate-900 dark:text-white">
                    {s.section2Card1Title}
                  </h3>
                  <p className="mt-2 text-sm leading-relaxed text-slate-600 dark:text-slate-300">
                    {splitBold(s.section2Card1Body, 'medium')}
                  </p>
                </div>
                <div className="rounded-xl border border-slate-200 bg-white p-6 dark:border-slate-700 dark:bg-slate-800/55">
                  <h3 className="text-lg font-semibold text-slate-900 dark:text-white">
                    {s.section2Card2Title}
                  </h3>
                  <p className="mt-2 text-sm leading-relaxed text-slate-600 dark:text-slate-300">
                    {splitBold(s.section2Card2Body, 'medium')}
                  </p>
                </div>
                <div className="rounded-xl border border-slate-200 bg-white p-6 dark:border-slate-700 dark:bg-slate-800/55">
                  <h3 className="text-lg font-semibold text-slate-900 dark:text-white">
                    {s.section2Card3Title}
                  </h3>
                  <p className="mt-2 text-sm leading-relaxed text-slate-600 dark:text-slate-300">
                    {splitBold(s.section2Card3Body, 'medium')}
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="mx-auto max-w-6xl px-4 md:px-6">
            <div className="mx-auto max-w-4xl">
              ...
              <ol className="mt-8 list-decimal space-y-4 pl-5 text-base leading-relaxed text-slate-600 dark:text-slate-300">
                <li>{s.section3Step1}</li>
                <li>{s.section3Step2}</li>
                <li>{splitBold(s.section3Step3, 'medium')}</li>
                <li>{s.section3Step4}</li>
              </ol>
            </div>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-6xl px-4 md:px-6">
            <div className="mx-auto max-w-4xl">
              ...
              <ul className="mt-6 list-disc space-y-2 pl-5 text-base leading-relaxed text-slate-600 dark:text-slate-300">
                <li>{s.section4Bullet1}</li>
                <li>{s.section4Bullet2}</li>
                <li>{s.section4Bullet3}</li>
                <li>{splitBold(s.section4Bullet4, 'medium')}</li>
              </ul>
            </div>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-6xl px-4 md:px-6">
            <div className="mx-auto max-w-4xl">
              ...
              <p className="mt-6 text-base leading-relaxed text-slate-600 dark:text-slate-300">
                {splitBold(s.section5Body, 'medium')}
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-6xl px-4 md:px-6">
            <div className="mx-auto max-w-4xl space-y-4">
              <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                ...
                <Link
                  href={withBasePath(s.internalLink1Href)}
                  className={`${softButtonClass} w-full shrink-0 md:w-auto ${focusRing}`}
                >
                  <span>{s.internalLink1Label}</span>
              ...
              <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                ...
                <Link
                  href={withBasePath(s.internalLink2Href)}
                  className={`${softButtonClass} w-full shrink-0 md:w-auto ${focusRing}`}
                >
                  <span>{s.internalLink2Label}</span>
                  <span aria-hidden="true">→</span>
                </Link>
              </div>
            </div>
