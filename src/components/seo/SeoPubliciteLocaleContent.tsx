...
export function SeoPubliciteLocaleContent() {
  const { t } = useLanguage();
  const s = t.seoPubliciteLocale;
  const section1Paragraphs = s.section1Text.split('\n\n');
  const section2Paragraphs = s.section2Text.split('\n\n');
